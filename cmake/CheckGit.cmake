...
function(CheckGitVersion)
  ...
  string(SUBSTRING ${GIT_HASH_FULL} 0 8 GIT_HASH)

  execute_process(
    COMMAND git rev-list --count ${GIT_HASH_FULL}
    WORKING_DIRECTORY ${CMAKE_CURRENT_LIST_DIR}
  ...
  if(NOT EXISTS ${post_configure_dir}/git_version.h)
    file(COPY ${pre_configure_dir}/git_version.h
  ...
  # Only update the git_version.cpp if the hash has changed. This will prevent
